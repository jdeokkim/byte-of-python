...
이것은 하나의 기능을 구성하는 모든 문장을 똑같이 들여써야 함을 의미하는데, 이렇게 기능 하나를 이루는 여러 문장의 묶음을 블록 (block)이라고 합니다. We will see examples of how blocks are important in later chapters.
